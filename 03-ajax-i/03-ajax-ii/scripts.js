...
form.addEventListener('submit', (e) => {
    e.preventDefault()
    console.log(characters.selectedIndex) // el indice del option seleccionado
    console.log(characters.children[characters.selectedIndex].value) // el value del option
...
const getData = (id) =>{
    ...
    else xhr = new ActiveXObject("Mirosoft.XMLHTTP")

    // si no hacemos consultas desde el formulario 
    if(id==undefined){
    ...
    }else{ //ejecutamos consultas desde el formulario
